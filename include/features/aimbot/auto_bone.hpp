...
namespace autobone {
    ...
    static bool ResolvePosition(void* context, u8 selector, ResolveDirect resolveDirect,
        Vec3* position) {
    ...
    static bool Try(void* context, TrySelector trySelector, u8 selector, float* bestDamage,
        SelectResult* result) {
    ...
    static bool SelectPriority(const SelectInput& input, void* context, TrySelector trySelector,
        float* bestDamage, SelectResult* result) {
    ...
    static bool Select(const SelectInput& input, SelectState* state, void* context,
        TrySelector trySelector, float initialBestDamage, SelectResult* result) {
