...
namespace aimbot {
    bool DirectBulletTrace(void* cg, char* entities, int localIdx, int targetIdx, const Vec3& start,
        const Vec3& end) {
    ...
    static const char* const kBoneNames[] = {
        "j_head_end",         "tag_eye",            "j_head",             "j_neck",
        "j_spine4",           "tag_stowed_back",    "j_spineupper",       "j_mainroot",
        "j_spinelower",       "j_shoulder_ri",      "j_shoulder_le",      "j_clavicle_le",
        "j_clavicle_ri",      "j_shouldertwist_ri", "j_shouldertwist_le", "j_shoulderraise_ri",
        "j_shoulderraise_le", "j_elbow_ri",         "j_elbow_le",         "j_elbow_bulge_ri",
        "j_elbow_bulge_le",   "j_wrist_ri",         "j_wrist_le",         "j_wristtwist_ri",
        "j_wristtwist_le",    "j_mid_ri_1",         "j_mid_le_1",         "back_low",
        "pelvis",             "j_hip_ri",           "j_hip_le",           "j_hiptwist_ri",
        "j_hiptwist_le",      "j_knee_ri",          "j_knee_le",          "j_knee_bulge_ri",
        "j_knee_bulge_le",    "j_ankle_ri",         "j_ankle_le",         "j_ball_ri",
        "j_ball_le",          "j_pinky_le_3",       "j_pinky_ri_3",       "j_index_ri_3",
        "j_index_le_3",       "j_mid_le_3",         "j_mid_ri_3",         "j_ring_le_3",
        "j_ring_ri_3",        "j_thumb_le_3",       "j_thumb_ri_3"
    };
