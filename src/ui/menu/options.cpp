...
namespace reconrender {
    ...
    void addSliderToggle(const char* l, u32 va, u32 enableVa, float lo, float hi, float st,
        int fmt) {
    ...
    static bool IsModderName(const char* n) {
        static const char* const kSig[] = {
            "XBOX360LSBEST",      "^6J^5i^6g^5g^6y", "^1B^5at^1M^5an",         "TCM",
            "^5C^3h^5e^3a^5t^3s", "XBL^5Pony",       "^5J^1i^5g^1g^5y",        "ELeGanCe",
            "Bossam",             "Predator",        "by: Matrix",             "Serenity",
            "xePixTvx",           "Project Iconic",  "Conversion",             "Zombieland",
            "Velocity",           "Kamil_Modz",      "RM|T Zombies Menu V2.6",
        };
