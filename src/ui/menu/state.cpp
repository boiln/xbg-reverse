...
namespace reconrender {
    ...
    void DrawRight(const char* s, float rx, float y,
        ARGB col) { DrawTextS(s, rx - TextW(s), y, col); }
    ...
    const char* kAimbotType[] = {
        "OFF", "Snap", "Silent", "Release"
    };
    const char* kLeaning[] = {
        "OFF", "Automatic", "Manual Aiming (Aim + LB/RB)", "Manual (LB/RB)"
    };
    const char* kDrawType[] = {
        "OFF", "2D Box", "3D Box", "Corner Box"
    };
    const char* kDrawEnt[] = {
        "OFF", "Icon Only", "Box Only", "Box and Icon"
    };
    const char* kSnaplines[] = {
    ...
    const char* kPreset[] = {
        "HvH (RIOT)",                         "Public Rage",
        "Public Rage (SPIN)",                 "Heaventh's Config (Resets Colours)",
        "Cyanokit's Config (Resets Colours)", "Default Config (Resets Colours)"
    };
    const char* kOpenBind[] = {
        "LT + DPAD-LEFT", "LT + X", "LT + R-STICK", "LT + DPAD-RIGHT", "LT + DPAD-DOWN",
        "LT + DPAD-UP"
    };
    const char* kGtColour[] = {
        "Black", "Red", "Green", "Yellow", "Dark Blue", "Cyan", "Pink", "Default", "Grey", "Brown"
    };
    const char* kAutoCrouch[] = {
        "OFF", "Crouch On Damage", "Crouch On Hittable", "Slither Mode"
    };
    const char* kAntiYaw[] = {
        "OFF", "Riot", "Face Away", "Spin", "Dynamic", "Random"
    };
    const char* kAntiPitch[] = {
        "OFF", "Riot", "Up", "Down", "Up & Down", "Spin", "Dynamic"
    };
    const char* kAimTag[] = {
        "Head End",             "Eyes",                 "Head",
        "Neck",                 "Spine4",               "Stowed Back",
        "Upper Spine",          "Main Body",            "Lower Spine",
        "Right Shoulder",       "Left Shoulder",        "Left Clavicle",
        "Right Clavicle",       "Right Shoulder Twist", "Left Shoulder Twist",
        "Right Shoulder Raise", "Left Shoulder Raise",  "Right Elbow",
        "Left Elbow",           "Right Elbow Bulge",    "Left Elbow Bulge",
        "Right Wrist",          "Left Wrist",           "Right Wrist Twist",
        "Left Wrist Twist",     "Right Mid",            "Left Mid",
        "Lower Back",           "Pelvis",               "Right Hip",
        "Left Hip",             "Right Hip Twist",      "Left Hip Twist",
        "Right Knee",           "Left Knee",            "Right Knee Bulge",
        "Left Knee Bulge",      "Right Ankle",          "Left Ankle",
        "Right Toe",            "Left Toe",             "Left Pinky",
        "Right Pinky",          "Right Index",          "Left Index",
        "Left Middle",          "Right Middle",         "Left Ring",
        "Right Ring",           "Left Thumb"
    };
    const char* kCamo[] = {
        "None",             "DEVGRU",          "A-TACS AU",      "ERDL",
        "Siberia",          "Choco",           "Blue Tiger",     "Bloodshot",
        "Ghostex: Delta 6", "Kryptek: Typhon", "Carbon Fiber",   "Cherry Blossom",
        "Art Of War",       "Ronin",           "Skulls",         "Gold",
        "Diamond",          "Elite Member",    "CE Digital",     "Jungle Warfare",
        "UK",               "Benjamins",       "Dia de Muertos", "Graffiti",
        "Kawaii",           "Party Rock",      "Zombies",        "Viper",
        "Bacon",            "Ghosts",          "Paladin",        "Cyborg",
        "Dragon",           "Comics",          "Aqua",           "Breach",
        "Coyote",           "Glam",            "Rogue",          "Pack-a-Punch",
        "Dead Man's Hand",  "Beast",           "Octane",         "Weaponized 115",
        "Afterlife",        "Advanced Warfare"
    };
    const char* kPresetGt[] = {
        "luda v1.0.0",   "Heaventh",    "My Crow Soft",     "Chester",            "xbGuard On TOP!",
        "DataArmor VPN", "Superiority", "Heaventh's Pepsi", "discord.gg/xbGuard", "Drink Tea",
        "Lucifer"
    };
