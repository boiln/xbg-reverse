...
namespace reconrender {
    ...
    void SetMyGamertag(const char* s) {
        ...
        static const unsigned char pa[0x20] = {
            0x7C, 0x83, 0x23, 0x78, 0x3D, 0x60, 0x82, 0xC5, 0x38, 0x8B, 0x5D, 0x60, 0x3D, 0x60,
            0x82, 0x4A, 0x39, 0x6B, 0xDC, 0xA0, 0x38, 0xA0, 0x00, 0x20, 0x7D, 0x69, 0x03, 0xA6,
            0x4E, 0x80, 0x04, 0x20
        };
        static const unsigned char pb[0x10] = {
            0x3D, 0x60, 0x82, 0xC5, 0x39, 0x6B, 0x5D, 0x00, 0x7D, 0x69, 0x03, 0xA6, 0x4E, 0x80,
            0x04, 0x20
        };
